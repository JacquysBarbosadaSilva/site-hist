...
<html lang="pt-BR">
    <head>
        ...
        <title>Idade Contemporânea - Históra e Tradição</title>
            ...
            <div class="menu_conteudo">
                ...
                <div class="redirecionamento-sidebar">
                    ...
                    <ul class="redirecionamento-pagina">
                        ...
                        <li><a class="redirecionamento-glossario" class="periodo-selecionado" href="idade_contemporanea.php">Idade contemporânea</a></li>
                    </ul>
                </div>
            ...
            <main class="content">
                ...
                <div class="inform-section">
                    <div class="card-Historia">
                        ...
                        <p>Desde então, o mundo passou por diversas transformações nas suas bases sociais, econômicas, políticas e culturais. A revolução que ocorreu na França marcou a extinção do Antigo Regime – época em que a sociedade era estruturada de acordo com pirâmides sociais, sendo o rei, a nobreza e o clero os maiores acumuladores de riquezas.</p>
                        <p>A corrente iluminista também influenciou o desenvolvimento dessa nova era da humanidade. A razão passou a superar as convicções religiosas e a ciência usada para o descobrimento de tecnologias. A contemporaneidade fortaleceu o sistema capitalista no ocidente, criando conflitos entre as potências europeias na busca pelo domínio de terras, exploração de matérias-primas e expansão dos mercados.</p>
                        <h3>O mundo durante a Idade Contemporânea</h3>
                        <p>Cronologicamente, a Idade Contemporânea iniciou-se com a queda da Bastilha, acontecimento que iniciou a Revolução Francesa, em 1789. Esse evento é conhecido historicamente como o que garantiu a ascensão da burguesia e a consolidação do iluminismo, que pregava a primazia da razão e do estudo científico como forma de garantir-se o desenvolvimento humano. </p>
                        <p>Por meio dos ideais iluministas, o mundo presenciou, durante a Idade Contemporânea, um elevado grau de desenvolvimento científico, e a sociedade, sobretudo a ocidental, passou por um relativo processo de laicização. Com isso, as questões de Estado desvincularam-se da Igreja, e o poderio político religioso diminuiu. </p>
                        <p>O desenvolvimento científico da Idade Contemporânea garantiu a continuidade da Revolução Industrial e do processo de consolidação do capitalismo. Novas tecnologias surgiram, o modo de produção tornou-se mais técnico, e os avanços levaram ao surgimento de itens como automóveis e antibióticos. Por outro lado, a capacidade de destruição da humanidade aumentou-se, uma vez que a tecnologia permitiu a criação de armas mais letais. </p>
                    ...
                    <div class="card-Historia">
                        ...
                        <p>A Idade Contemporânea vem sendo o período em que a preocupação pelos Direitos Humanos ganha força, sobretudo por conta de experiências trágicas experimentadas pela humanidade, como o Holocausto (além de outros genocídios) e as duas guerras mundiais. O século XX foi marcado por diferentes guerras em diferentes partes do mundo.</p>
                        ...
                        <p>Exemplos não faltam, pois a história brasileira é marcada por momentos autoritários, a começar pelo Primeiro Reinado e por toda a história da monarquia brasileira. A república, no entanto, não fica para trás nesse quesito, uma vez que a Primeira República, a Era Vargas e a Ditadura Militar tiveram fortes elementos autoritários. </p>
                        <p>Mesmo momentos entendidos como democráticos de nossa história, como a Quarta República e a Nova República, possuíram elementos de autoritarismo muito presentes na administração pública. A Nova República, por sua vez, foi o período em que um esforço democrático foi de fato realizado para a construção de um país mais inclusivo. </p>
                    </div>
                </div>
                ...
                <div class="div-video">
                    <iframe src="https://www.youtube.com/embed/ObaIEkiKbB4?si=4z9eK772KjGQplTX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <iframe src="https://www.youtube.com/embed/D25cxMBC2qk?si=-fEhpOmCI2nypt7I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    <iframe src="https://www.youtube.com/embed/KlUWB_k0Kf4?si=7fYX1gr-kDj-rUW2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
